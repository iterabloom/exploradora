...
**STATUS: pre-alpha — governance, licensing, and CI scaffolding are in place;
the package itself is not yet implemented, and nothing is published to PyPI.**
...
the dual-license layout, PR automation, and a Woodpecker CI gate. Missing:
everything else — the package, the TUI, the manifest schema, the verifier,
the tests.
